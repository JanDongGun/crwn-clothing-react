...
function loadBundle(data) {
    return databaseD95963f8.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    var _this = this;
    return databaseD95963f8.namedQuery(this._delegate, queryName).then(function (expQuery) {
        if (!expQuery) {
            return null;
        }
        return new databaseD95963f8.Query$1(_this, 
...
registerBundle(databaseD95963f8.Firestore);
